...
export const FILTER_LIFECYCLE = 'FILTER_LIFECYCLE'
export const FILTER_PUBLICATION_TYPE = 'FILTER_PUBLICATION_TYPE'
...
export function testRoutingWithFilters(filterObject){

	// console.log("testRoutingWithFilters")
